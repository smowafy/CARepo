...
public class Alu {
	...
	public int zero(int[] value1, int[]value2){
		int value12 = conv.BitsToIntegerSigned(value1);
		int value22 = conv.BitsToIntegerSigned(value2);
	...
	public int [] doOperation(int []value1, int[]value2, int[]aluControlInput){
		int op = conv.BitsToIntegerSigned(aluControlInput);
		int value21 = conv.BitsToIntegerSigned(value1);
		int value22 = conv.BitsToIntegerSigned(value2);
		int value1u = conv.BitsToInteger(value1);
		int value2u = conv.BitsToInteger(value2);
		switch(op){
